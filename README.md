...
- [浏览游戏运行资产](assets/)：角色、道具、贴图、音效、字体。
- [下载完整资产包](https://github.com/AIWHOS/paper-ember-duel/releases/download/v0.2.1/paper-ember-duel-assets-20260913.zip)：同时提供原始高模、BANG 分件与 Blender 源文件。
- [资产目录与检查结果](docs/纸烬决斗_资产下载说明_20260913.md) · [逐文件清单](docs/纸烬决斗_资产清单_20260913.json)

## 文件与许可说明

`scripts/` 为游戏逻辑，`assets/` 为运行模型、纹理、字体和音效，`docs/` 为制作说明，`verification/` 用于本地检查输出。高模与 Blender 制作源文件通过上方 Releases 资产包提供；账号记录、引擎安装包及生成缓存不包含在发布内容中。
